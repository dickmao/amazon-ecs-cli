...
func createServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(append(deploymentConfigFlags(true), append(loadBalancerFlags(), flags.OptionalConfigFlags()...)...), flags.OptionalLaunchTypeFlag(), flags.OptionalCreateLogsFlag(), OptionalServiceConfigsFlag()),
...
func rmServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(flags.OptionalConfigFlags(), ComposeServiceTimeoutFlag(), OptionalServiceConfigsFlag()),
