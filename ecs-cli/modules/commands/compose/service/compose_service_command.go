...
func createServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(append(deploymentConfigFlags(true), append(loadBalancerFlags(), flags.OptionalConfigFlags()...)...), flags.OptionalLaunchTypeFlag(), flags.OptionalCreateLogsFlag(), flags.OptionalServiceConfigsFlag()),
...
func upServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(append(append(append(deploymentConfigFlags(true), append(loadBalancerFlags(), flags.OptionalConfigFlags()...)...), ComposeServiceTimeoutFlag()), flags.OptionalLaunchTypeFlag(), flags.OptionalCreateLogsFlag()), flags.OptionalServiceConfigsFlag(), ForceNewDeploymentFlag()),
...
func psServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(flags.OptionalConfigFlags(), flags.OptionalServiceConfigsFlag()),
...
func rmServiceCommand(factory composeFactory.ProjectFactory) cli.Command {
	return cli.Command{
		...
		Flags:        append(flags.OptionalConfigFlags(), ComposeServiceTimeoutFlag(), flags.OptionalServiceConfigsFlag()),
