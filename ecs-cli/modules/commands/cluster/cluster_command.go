...
func UpCommand() cli.Command {
	return cli.Command{
		...
		Flags:        append(clusterUpFlags(), append(existingUpFlags(), flags.OptionalConfigFlags()...)...),
...
func templateUpFlags() []cli.Flag {
	return []cli.Flag{
		cli.StringFlag{
			Name:  flags.CustomTemplateFlag,
			Usage: "Required custom template file.",
		},
	}
}
